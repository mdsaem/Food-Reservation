                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                ...
                                <p class="section-content-para">
                                    Astronomy compels the soul to look upward, and leads us from this world to another.  Curious that we spend more time congratulating people.
                                </p>
                                <p class="section-content-para">
                                    beautiful, warm, living object looked so fragile, so delicate, that if you touched it with a finger it would crumble.
                                </p>
                            </div> <!-- /.section-content -->
                        </div>
                    </div> <!-- /.row -->
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="section-header">
                        <h2 class="pricing-title">Our Menu List And Affordable Pricing</h2>
            ...
            <div class="row">  
                ...
                @foreach($items as $item)
                 ...
                 <li class="item" id="{{$item->category->slug}}">
                            ...
                            <a href="#">
                                <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Food"  style="height: 300px; width: 300px">
                                <div class="menu-desc">
                                    <span>
                                        <h3>{{$item->name}}</h3>
                                        {{$item->description}}
